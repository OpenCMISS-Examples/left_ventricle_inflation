...
inputNodes = exfile.Exnode(os.path.join(path,"ellipse_benchmark_lin_"+str(elems[2])+"-"+str(elems[1])+"-"+str(elems[0])+".exnode"))
inputElems = exfile.Exelem(os.path.join(path,"ellipse_benchmark_lin_"+str(elems[2])+"-"+str(elems[1])+"-"+str(elems[0])+".exelem"))
...
unrefinedNodes = exfile.Exnode(os.path.join(path,"unrefined_mesh.exnode"))
...
deformed = exfile.Exnode(os.path.join(path,"LVInflation_trilinear_"+str(elems[2])+"-"+str(elems[1])+"-"+str(elems[0])+".part0.exnode"))
